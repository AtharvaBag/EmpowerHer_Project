         ...
         %>          
                        <form action="Admin_Course_Details" method="POST">
                                <tr>
                                    ...
                                    <td><input type="text" value="<%=entry.getKey().getCoursetitle().replace("*", "'")%>" name="verifiedcoursename" readonly></td>
         ...
         %>          
                        <form action="Admin_Course_Details" method="POST">
                                <tr>
                                    ...
                                    <td><input type="text" value="<%=entry.getKey().getCoursetitle().replace("*", "'")%>" name="unverifiedcoursename" readonly></td>
